...
#[doc = r" ```"]
pub const VND_OPENXMLFORMATS_OFFICEDOCUMENT_SPREADSHEETML_PIVOTCACHEDEFINITION_XML: Mime = Mime {
    ttype: "application",
...
#[doc = r" ```"]
pub const VND_OPENXMLFORMATS_OFFICEDOCUMENT_SPREADSHEETML_VOLATILEDEPENDENCIES_XML: Mime = Mime {
    ttype: "application",
...
#[doc = r" ```"]
pub const VND_OPENXMLFORMATS_OFFICEDOCUMENT_WORDPROCESSINGML_DOCUMENT_GLOSSARY_XML: Mime = Mime {
    ttype: "application",
